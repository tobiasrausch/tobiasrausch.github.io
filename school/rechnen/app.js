...
['Mama sitzt im  ...', 'Dach', 'Huhn', 'Baum', 'Sessel'],
['Alle Esel essen  ...', 'Sushi', 'Lampen', 'Mantel', 'Salat'],
['Polli mag  ...', 'lesen', 'schwimmen', 'Tee', 'Milch'],
['Welcher Name beginnt mit P?', 'Nino', 'Nina', 'Jojo', 'Polli'],
['Welcher Name endet mit a?', 'Nino', 'Leon', 'Jojo', 'Nina'],
['Im Winter ist es drinnen warm und draußen ...', 'links', 'rot', 'langsam', 'kalt'],
['Nino ist krank. Mama misst Ninos ...', 'Katze', 'Husten', 'Schnupfen', 'Temperatur'],
['Mama nimmt Nina in den ...', 'Kofferraum', 'Handtasche', 'Autoreifen', 'Arm'],
['Nina spielt mit Leon im ...', 'Rasen', 'Ohr', 'Tisch', 'Zimmer'],
['Wenn es Nacht in China ist, dann ist es bei uns ...', 'dunkel', 'kalt', 'warm', 'hell'],
['Ninos Papa kommt aus ...', 'Wolfsburg', 'Berlin', 'Kanada', 'Italien'],
['Nina und Leon helfen Mama im ...', 'Zoo', 'Tankstelle', 'Park', 'Haushalt'],
['Nino ist die Abkürzung für ...', 'Nina', 'Leon', 'Jojo', 'Antonio'],
['Was passt nicht in einen Obstsalat?', 'Bananen', 'Birnen', 'Mandarinen', 'Eis'],
['Im Schwimmbad kann man ...', 'kochen', 'bohren', 'leimen', 'tauchen'],
['Nina möchte heute ein Buch ...', 'fahren', 'lenken', 'trinken', 'lesen'],
['Auf der Weide grast eine ...', 'Traktor', 'Kind', 'Mama', 'Kuh'],
['Welches Wort reimt sich mit kaufen?', 'sollen', 'wollen', 'lesen', 'laufen'],
['Welches Wort reimt sich mit sollen?', 'kaufen', 'laufen', 'lesen', 'wollen'],
['Welches Wort reimt sich mit Sonne?', 'Tanne', 'Spange', 'Haare', 'Tonne'],
['Welches Wort reimt sich mit Klee?', 'Tafel', 'Wanne', 'Weste', 'See'],
['Welches Wort reimt sich mit Teil?', 'Eis', 'Land', 'Wand', 'Seil'],
['Was ist rot?', 'Kuh', 'Pferd', 'Schneeglöckchen', 'Rosen'],
['Was ist blau?', 'Sonne', 'Gold', 'Silber', 'Wasser'],
['Was kann rollen', 'Buch', 'Haus', 'Klavier', 'Roller'],
['Was ist ein Baum?', 'Rasen', 'Mensch', 'Blume', 'Tanne'],
['Was ist ein Tier?', 'Schrank', 'Ball', 'Stuhl', 'Ameise'],
['Was ist rund?', 'Baum', 'Fahrrad', 'Schuh', 'Perle'],
['Wer hat ein Fell?', 'Auto', 'Schrank', 'Fenster', 'Affe'],
['Was ist weich?', 'Holz', 'Stein', 'Knochen', 'Pudding'],
['Zwei Tauben sitzen auf dem ...', 'Klo', 'Buch', 'Stift', 'Dach'],
['Die Königin küsst den ...', 'Baum', 'Schrank', 'Hut', 'König'],

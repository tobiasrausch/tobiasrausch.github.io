...
![delly]({{ site.url }}/assets/img/delly.png) | **[Delly][de]** | Structural variant discovery by integrated paired-end and split-read analysis
![alfred]({{ site.url }}/assets/img/alfred.png) | **[Alfred][al]** | BAM Statistics and Feature Counting
![indigo]({{ site.url }}/assets/img/indigo.png) | **[Indigo][in]** | InDel Discovery in Chromatogram traces obtained from Sanger sequencing of PCR products
